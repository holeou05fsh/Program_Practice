...
在之前服務業的工作中，有許多點餐、叫餐的工作要做，而此服務也在花費了許多時間，也會有許多的問題發生，例如叫錯餐、少餐、忙碌而延餐、記帳錯誤等問題，等許多狀況發生，因而想寫以點餐為主的網站，此網站主要由2大應用，一、前台系統：已員工於前台網站進行客戶點餐作業操作，二、後台系統：以管理員控管員工信息、店家資訊、菜品分類及資訊、會員訊息管理等應用。
...
📂myweb/ 項目目錄
  ...
  |    |--📂views/
  |    |    |--📄cart.py 購物車管理視圖
  |    |    |--📄index.py 前台的登錄、退出、驗證碼、加載店舖商品等方法
  |    |    |--📄orders.py 訂單管理視圖
  |    |--📄urls.py 配置了整個網站前台所有請求路由
  |
  |--📂myobject/ 項目目錄
  |    |--📄settings.py 設定前後台app、中間件、TEMPLATES、STATICFILES
  |    |--📄urls.py 加載所有網站前後台的路由
  |    |--📄wsgi.py
  |
  |--📂statics/ 靜態資源目錄
...
****
![13](https://user-images.githubusercontent.com/79140074/141614794-f54afef9-1634-48df-8b0e-de1befa87b60.png)
當前訂單：瀏覽客人訂購中的餐點，如果餐點作完後，點擊完成資料則會進入至歷史訂單，點擊刪除資料則會進入至無效訂單
****
![14](https://user-images.githubusercontent.com/79140074/141614795-64c195c3-ed65-476d-8503-db69816b9db0.png)
歷史訂單：瀏覽客人已完成的訂單，點擊詳情則會顯示該訂單的點餐明細。
****
![15](https://user-images.githubusercontent.com/79140074/141614796-08f10d92-0e9c-4506-8d19-d16c88ddf8fd.png)
無效訂單：瀏覽刪除的訂單，點擊詳情則會顯示該訂單的點餐明細。
****
![16](https://user-images.githubusercontent.com/79140074/141614797-5c545977-5e57-40cc-86cb-509380db9b80.png)
訂單中的明細

## 🔚  結論：
本作品為Django課程中的製作作品，也貼合之前工作經歷遇到的狀況，此作品也能解決部分在點餐的問題，雖然有許多不足的地方，但希望多充實能力能夠，讓此網站有更多的功能及更快的效能等，本作品主要以網站對於SQL進行增刪改查等操作的練習，更讓我熟悉了Django的結構與用法等。
